    ...
    >
          ...
          {!autoFit && (
            <div className="flex items-center gap-1">
              <button
                ...
                className="w-5 h-5 rounded bg-neutral-800 hover:bg-neutral-700 flex items-center justify-center text-white text-xs"
              >
                -
              </button>
              <button
              ...
              <button
                onClick={() => setScale(1)}
                className="text-[10px] px-1 text-neutral-400 hover:text-white"
              >
                100%
              </button>
            </div>
      ...
      >
        ...
        {deviceType === 'mobile' && (
          ...
          >
            {/* Dynamic Island / Speaker Decoration (Outside website content) */}
            {showDecorations && (
            ...
            {/* Internal Screen Viewport (Strict Fixed Width/Height, Scrollable Inside) */}
            <div
              ...
              style={{
                transform: 'translateZ(0)', // Establishes CSS containing block for modals/sticky
              }}
            >
              {children}
            </div>
