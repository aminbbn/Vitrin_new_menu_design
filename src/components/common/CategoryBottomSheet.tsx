      ...
      >
        ...
        >
          ...
          <div className="flex items-center justify-between pb-4 border-b border-neutral-800">
            ...
            <button
              onClick={onClose}
              className="w-8 h-8 rounded-full bg-neutral-800 hover:bg-neutral-700 text-neutral-300 flex items-center justify-center transition-colors active:scale-95"
              aria-label="بستن"
            >
              <X className="w-4 h-4" />
            </button>
